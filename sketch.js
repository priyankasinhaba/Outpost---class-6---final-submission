...
function preload(){
    ...
    enemy5_img = loadImage('enemy5.png')
...
//play and about buttons for splash screen
...
Player.scale = 0.07
//Player.debug=true;
Player.setCollider ("Rectangle", 0, 0, 100,100,0)
 

enemy1 = createSprite(140,200)
enemy1.addImage(enemy1_img);
enemy1.scale = 0.2
enemy1.velocityX=1
enemy1.velocityY=-1;

enemy2 = createSprite(170,350)
enemy2.addImage(enemy2_img);
enemy2.scale = 0.2
enemy2.velocityX=1
enemy2.velocityY=-1

enemy3 = createSprite(409,505)
enemy3.addImage(enemy3_img);
enemy3.scale = 0.1
enemy3.velocityX=1
enemy3.velocityY=-1

enemy4 = createSprite(33,424)
enemy4.addImage(enemy4_img);
enemy4.scale = 0.08
enemy4.velocityX=1
enemy4.velocityY=-1

enemy5 = createSprite(178,490)
enemy5.addImage(enemy5_img);
enemy5.scale = 0.1
enemy5.velocityX=1
enemy5.velocityY=-1
...
if(keyWentUp("RIGHT_ARROW"))
{
 ...
 Player.bounceOff(wall20)
  ...
  enemy4.bounceOff(wall5)
  enemy4.bounceOff(wall6)
  enemy4.bounceOff(wall7)
  enemy4.bounceOff(wall8)
  enemy4.bounceOff(wall9)
  enemy4.bounceOff(wall10)
  enemy4.bounceOff(wall11)
  enemy4.bounceOff(wall12)
  enemy4.bounceOff(wall13)
  enemy4.bounceOff(wall14)
  enemy4.bounceOff(wall15)
  enemy4.bounceOff(wall16)
  enemy4.bounceOff(wall17)
  enemy4.bounceOff(wall18)
  enemy4.bounceOff(wall19)
  enemy4.bounceOff(wall20)




  enemy5.bounceOff(wall1)
  enemy5.bounceOff(wall2)
  enemy5.bounceOff(wall3)
  enemy5.bounceOff(wall4)
  enemy5.bounceOff(wall5)
  enemy5.bounceOff(wall6)
  enemy5.bounceOff(wall7)
  enemy5.bounceOff(wall8)
  enemy5.bounceOff(wall9)
  enemy5.bounceOff(wall10)
  enemy5.bounceOff(wall11)
  enemy5.bounceOff(wall12)
  enemy5.bounceOff(wall13)
  enemy5.bounceOff(wall14)
  enemy5.bounceOff(wall15)
  enemy5.bounceOff(wall16)
  enemy5.bounceOff(wall17)
  enemy5.bounceOff(wall18)
  enemy5.bounceOff(wall19)
  enemy5.bounceOff(wall20)
